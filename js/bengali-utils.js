...
const bengaliUtils = {
     ...
     * @returns {string} Bengali number representation
     */
     ...
     * @param {number} num - Number to convert
     * @returns {string} Bengali word
     */
    getBengaliWord: function(num) {
        const bengaliWords = {
     ...
     * @returns {string} Bengali text for TTS
     */
    getMultiplicationText: function(num1, num2) {
     ...
     * @returns {string} String with teddy bear emojis
     */
    getTeddyBears: function(count) {
        let charString = '';
